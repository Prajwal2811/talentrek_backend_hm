...
return new class extends Migration
{
    ...
    public function up()
    {
       Schema::create('additional_info', function (Blueprint $table) {
            ...
            $table->string('doc_type');           // e.g., Resume, Certificate, ID Proof
            $table->string('document_name');      // Display name or original name
            $table->string('document_path');      // Path or URL to the uploaded file
